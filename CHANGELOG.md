...
- Release v0.2.1 ([#78](https://github.com/srnnkls/phora/pull/78))
...
- *(release)* Bump the minor version for features ([#93](https://github.com/srnnkls/phora/pull/93))

[0.3.0]: https://github.com/srnnkls/phora/compare/0.2.0..0.3.0
